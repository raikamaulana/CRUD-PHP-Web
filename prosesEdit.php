...
mysqli_query($mysqli, "update data_murid set nis='$nis', nisn='$nisn', nama='$nama', jenis_kelamin='$jeniskelamin', alamat='$alamat', tempat_lahir='$tempatlahir', tanggal_lahir='$tanggallahir' where id='$id'");
...
<head>
    ...
    <title>Proses Edit - <?php echo $nama; ?></title>
</head>
    ...
    <div class="h-screen flex justify-center items-center">
        <div class="w-96 border-4 border-black shadow-md shadow-black relative">
            ...
            <div class="px-4 py-4 bg-white">
                <h2 class="font-bold mb-2">Data telah berhasil diedit</h2>
